...
#ifndef __vibrato_mul_25ns_udo__HH__
#define __vibrato_mul_25ns_udo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vibrato_mul_25ns_udo) {
    ...
    SC_CTOR(vibrato_mul_25ns_udo):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
