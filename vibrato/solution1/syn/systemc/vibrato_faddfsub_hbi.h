...
#ifndef __vibrato_faddfsub_hbi__HH__
#define __vibrato_faddfsub_hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vibrato_faddfsub_hbi) {
    ...
    SC_CTOR(vibrato_faddfsub_hbi):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
