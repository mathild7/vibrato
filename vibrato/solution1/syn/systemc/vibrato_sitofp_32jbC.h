...
#ifndef __vibrato_sitofp_32jbC__HH__
#define __vibrato_sitofp_32jbC__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(vibrato_sitofp_32jbC) {
    ...
    SC_CTOR(vibrato_sitofp_32jbC):  ACMP_sitofp_U ("ACMP_sitofp_U") {
