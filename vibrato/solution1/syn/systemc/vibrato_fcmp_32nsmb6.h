...
#ifndef __vibrato_fcmp_32nsmb6__HH__
#define __vibrato_fcmp_32nsmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vibrato_fcmp_32nsmb6) {
    ...
    SC_CTOR(vibrato_fcmp_32nsmb6):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
