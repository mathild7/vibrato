...
#ifndef __vibrato_mul_53ns_pcA__HH__
#define __vibrato_mul_53ns_pcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vibrato_mul_53ns_pcA) {
    ...
    SC_CTOR(vibrato_mul_53ns_pcA):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
