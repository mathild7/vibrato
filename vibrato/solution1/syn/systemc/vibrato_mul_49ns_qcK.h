...
#ifndef __vibrato_mul_49ns_qcK__HH__
#define __vibrato_mul_49ns_qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vibrato_mul_49ns_qcK) {
    ...
    SC_CTOR(vibrato_mul_49ns_qcK):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
