...
#ifndef __vibrato_mul_63ns_vdy__HH__
#define __vibrato_mul_63ns_vdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vibrato_mul_63ns_vdy) {
    ...
    SC_CTOR(vibrato_mul_63ns_vdy):  ACMP_mul_us_U ("ACMP_mul_us_U") {
