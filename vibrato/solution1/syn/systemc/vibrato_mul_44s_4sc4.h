...
#ifndef __vibrato_mul_44s_4sc4__HH__
#define __vibrato_mul_44s_4sc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vibrato_mul_44s_4sc4) {
    ...
    SC_CTOR(vibrato_mul_44s_4sc4):  ACMP_mul_su_U ("ACMP_mul_su_U") {
