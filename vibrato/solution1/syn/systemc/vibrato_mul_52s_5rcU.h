...
#ifndef __vibrato_mul_52s_5rcU__HH__
#define __vibrato_mul_52s_5rcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vibrato_mul_52s_5rcU) {
    ...
    SC_CTOR(vibrato_mul_52s_5rcU):  ACMP_mul_su_U ("ACMP_mul_su_U") {
