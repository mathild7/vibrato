...
set IPName      "vibrato"
set Version     "1.0"
set DisplayName "Vibrato"
set Revision    "1905021451"
...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x10 delay W 0x0 "Data signal of delay" {{0 32 delay W 0 "Bit 31 to 0 Data signal of delay"}}} {0x18 depth W 0x0 "Data signal of depth" {{0 32 depth W 0 "Bit 31 to 0 Data signal of depth"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 0
set kernel_files {/root/workspace/vibrato/vibrato.cpp}
if {$enable_xo_gen} {
